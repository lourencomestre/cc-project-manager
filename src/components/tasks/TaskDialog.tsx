...
function TaskDialogForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-1.5">
        <Label htmlFor="task-name" className="text-xs">Nome</Label>
        <Input
          id="task-name"
          value={form.name}
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="space-y-1.5">
          <Label htmlFor="task-start" className="text-xs">Início</Label>
          <Input
            id="task-start"
            type="date"
        ...
        <div className="space-y-1.5">
          <Label htmlFor="task-end" className="text-xs">Fim</Label>
          <Input
            id="task-end"
            type="date"
            value={form.end_date ?? ""}
        ...
        <div className="space-y-1.5">
          <Label htmlFor="task-pct" className="text-xs">Conclusão (%)</Label>
          <Input
            id="task-pct"
            type="number"
            min={0}
            ...
            onChange={(e) =>
              set("completion_pct", Math.min(100, Math.max(0, Number(e.target.value))))
            }
            className="h-8 text-sm"
          />
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {form.has_risk && (
          <div className="space-y-1.5">
            <Label htmlFor="task-risk-impact" className="text-xs">Impacto</Label>
            <Input
              id="task-risk-impact"
      ...
      <div className="space-y-1.5">
        <Label htmlFor="task-notes" className="text-xs">Notas</Label>
        <Input
          id="task-notes"
          value={form.notes ?? ""}
